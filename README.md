...
## Original project by @pastorpflores

Thanks for the original project https://github.com/pastorpflores/Zotero-AI-organizer that served as my point of departure for further development. I decided to use API calls instead of direct sqlite-DB edits, because it broke my Zotero project sync (yey for backups!).
